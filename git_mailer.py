...
# -------------------------------------#
#    mail_git_deploy fct definition    #
# -------------------------------------#
def mail_git_deploy():
    user_name = 'YOUR_USER_NAME_OR_SERVER_NAME'
    process_name = 'Git deploy'

    mail_content = "******************************************************* <br> <br>" + \
                   "Git project has been deployed <br> <br>" + \
                    "* This is an automated email, please do not reply.* <br><br>*******************************************************"

    mailsender = MailSender('your.email@domain.fr', 'password', ('smtp.gmail.com', 587))
    mailsender.set_message(mail_content, "[" + user_name + "] - " + process_name, user_name, mail_content)
    mailsender.set_recipients(['recipient1@domaine.fr', 'recipient2@domain.fr'])
